...
Copy this file outside `.devin/automations/benny/`, for example to `.devin/benny/routing.md`, and replace every placeholder. Point `routing.map_path` at the copy. Pack refreshes must not overwrite it.
