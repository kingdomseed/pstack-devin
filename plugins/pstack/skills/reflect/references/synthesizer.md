...
- "Devin Review flagged regex backtracking on May 2"
...
| <new pattern, no existing skill is a real home> | <draft a new SKILL.md in Devin's format> | <new skill: <kebab-name>> |
