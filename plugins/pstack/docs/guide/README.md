...
0. [Running pstack on Devin](./00-devin.md). Install, the `/pstack:` namespace, model roles, and local versus cloud sessions.
...
Next: [Running pstack on Devin](./00-devin.md), then [Set up pstack](./01-setup.md).
